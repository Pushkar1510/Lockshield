...
root=Tk()
root.title("Locksheild - Hide a Secret Text Message in an Image")
root .geometry ("700x500+250+188")
...
Label(root,text="LOCKSHIELD", bg="#2d4155",fg="#3ddac3",font="arial 25 bold"). place(x=100, y=20)
...
#third Frame
frame3=Frame (root, bd=3, bg="#3ddac3" ,width=330, height=100, relief=GROOVE)
...
#fourth Frame
frame4=Frame(root, bd=3, bg="#3ddac3" ,width=330, height=100, relief=GROOVE)
